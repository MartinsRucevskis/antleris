...
logical_weak: 'NOT' logical_weak | compar;
logical_strong : logical_strong 'AND' logical_weak | logical_weak;
logical_strongest: logical_strongest 'OR' logical_strong | logical_strong;
